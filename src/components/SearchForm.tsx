    ...
    return (
        <div className="max-w-2xl mx-auto">
            <form action="" className="pt-10 mx-4 scale-x-110 ">
                <div className="flex bg-primary px-8 py-6 justify-between items-center rounded-xl translate-y-9 border-4 border-transparent hover:border-outColor transition-all duration-300 ease-in-out">
